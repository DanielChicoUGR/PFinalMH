...
std::pair<std::vector<double>, double> busqueda_local(const std::function<double(double *)> &fitness_func, const double &min, const double &max, const std::vector<double> &sol_ini, int MAX_ITERS, double mean, double std) {
    ...
    return {sol, mejor_fitness};
}

std::pair<std::vector<double>, double> Enfriamiento_simulado(const std::function<double(double *)> &fitness_func, const double &min, const double &max, const std::vector<double> &sol_ini, int MAX_ITERS, double mean, double std) {
